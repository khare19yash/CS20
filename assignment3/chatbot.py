...
def run_step(sess,model,encoder_inputs,decoder_inputs,decoder_masks,bucket_id,forward_only):
    ...
    for step in range(decoder_size):
        ...
        input_feed[model.decoder_masks[step].name] = deoder_masks[step]
...
def _eval_test_set(sess,model,test_buckets):
    ...
    for bucket_id in range(len(config.BUCKETS)):
        ...
        encoder_inputs,decoder_inputs,decoder_masks = data.get_batch(test_buckets[bucket_id],bucket_id,batch_size=config.BATCH_SIZE)
        
        _,step_loss,_ = run_step(sess,model,encoder_inputs,decoder_inputs,decoder_masks,nucket_id,True)
